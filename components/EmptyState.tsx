...
export default function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center border-2 border-dashed border-gray-300 rounded-2xl py-16 px-8 bg-gray-50/60">
      <div className="w-14 h-14 rounded-xl bg-white border border-gray-200 flex items-center justify-center mb-4">
        <Icon className="w-7 h-7 text-gray-400" />
      </div>
      <h3 className="text-lg text-gray-900 mb-1.5 font-[family-name:var(--font-fraunces)]">{title}</h3>
